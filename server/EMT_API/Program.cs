    ...
    {
        {
            ...
            builder.Services.AddScoped<IMembershipDAO, MembershipDAO>();
            ...
            builder.Services.AddScoped<IFlashcardProgressDAO, FlashcardProgressDAO>();
            builder.Services.AddScoped<IAIPromptDAO, AIPromptDAO>();
            builder.Services.AddScoped<IAISubmissionDAO, AISubmissionDAO>();
            builder.Services.AddScoped<IAIReviewDAO, AIReviewDAO>();
            builder.Services.AddScoped<ITeacherScoreDAO, TeacherScoreDAO>();
